...
<br>
<div class="container mt-5">
    <a href="{{ route('posts.index') }}" class="btn btn-md btn-success mb-3">TAMBAH KELAS</a>
  <div class="jumbotron">
      <h4>BERITA LAINYA</h4>
      <div class="card-container">
      <div class="card">
        <img src="img/sanket-shah-SVA7TyHxojY-unsplash.jpg" alt="Image 1">
        <div class="card-content">
            <h3 class="card-title">LOREM IPSUM</h3>
            <p class="card-description">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus mauris augue eu rutrum commodo.</p>
      ...
      <div class="card">
        <img src="img/Chefsolo.jpg" alt="Image 2">
        <div class="card-content">
            <h3 class="card-title">LOREM IPSUM</h3>
            <p class="card-description">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus mauris augue eu rutrum commodo.</p>
            <div class="card-footer">
      ...
      <div class="card">
        <img src="img/jimmy-dean-Jvw3pxgeiZw-unsplash.jpg" alt="Image 2">
        <div class="card-content">
            <h3 class="card-title">LOREM IPSUM</h3>
            <p class="card-description">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus mauris augue eu rutrum commodo.</p>
            <div class="card-footer">
      ...
      <div class="card">
        <img src="img/luisa-brimble-HvXEbkcXjSk-unsplash.jpg" alt="Image 2">
        <div class="card-content">
            <h3 class="card-title">LOREM IPSUM</h3>
            <p class="card-description">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus mauris augue eu rutrum commodo.</p>
            <div class="card-footer">
      ...
      <div class="card">
        <img src="img/sanket-shah-SVA7TyHxojY-unsplash.jpg" alt="Image 2">
        <div class="card-content">
            <h3 class="card-title">LOREM IPSUM</h3>
            <p class="card-description">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus mauris augue eu rutrum commodo.</p>
            <div class="card-footer">
  ...
  <div class="d-grid gap-2 col-4 mx-auto">
    <a class="btn btn-danger" href="" role="button">Create</a>
  </div>
</div>
      </div>
  </div>
